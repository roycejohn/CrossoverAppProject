    ...
    <footer className="bg-gray-800">
      ...
      <div className="bg-[#434343] py-8 px-4">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0 md:space-x-4">
          ...
          {/* Form */}
          <form className="text-white flex flex-col items-center md:space-x-4">
            <div>
              <input
                type="email"
                placeholder="E-mail"
            ...
            <div>
              <button
                type="submit"
                className="bg-yellow-500 text-gray-800 px-6 py-2 rounded-md transition duration-300 hover:bg-yellow-400 mt-5"
